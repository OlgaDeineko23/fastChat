...
var _ids = __webpack_require__(15);
...
var LIB_FUNCS = ['init', 'login', 'on', 'off', 'logout', 'sendMessage', 'triggerPostback', 'updateUser', 'getConversation', 'getUser', 'open', 'close', 'isOpened', 'startConversation'];
...
function injectFrame() {
    var REACT_DEBUG_SCRIPT =  false ? '<script> __REACT_DEVTOOLS_GLOBAL_HOOK__ = parent.__REACT_DEVTOOLS_GLOBAL_HOOK__ </script>' : '';
